...
def qk(update, context):
    ...
    if reply_user == None:
        if len(context.args) != 0:
            word = ' '
            context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Qk.mp4', 'rb'), supports_streaming=True, caption='Mi qk pa ti, ' + word.join(context.args))
        else:
            context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Qk.mp4', 'rb'), supports_streaming=True)
    else:
        if reply_user.from_user['username'] == None:            
            context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Qk.mp4', 'rb'), supports_streaming=True, caption='Mi qk pa ti, ' + reply_user.from_user['first_name'])
        else:
...
def this(update,context):
    context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/This.mp4', 'rb'), supports_streaming=True, caption='This is so much cancer')
...
def seso(update, context):
    ...
    if reply_user == None:
        if len(context.args) != 0:
            word = ' '
            context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Seso.mp4', 'rb'), supports_streaming=True, caption='Yo no sé de eso, ' + word.join(context.args) + ', hablame de seso mejor')
        else:
            context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Seso.mp4', 'rb'), supports_streaming=True)
    else:
        if reply_user.from_user['username'] == None:            
            context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Seso.mp4', 'rb'), supports_streaming=True, caption='Yo no sé de eso, ' + reply_user.from_user['first_name'] + ', hablame de seso mejor')
        else:
            context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Seso.mp4', 'rb'), supports_streaming=True, caption='Yo no sé de eso, @'+ reply_user.from_user['username'] + '(' + reply_user.from_user['first_name'] + '), hablame de seso mejor')

def tiktok(update,context):
    context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Tiktok.mp4', 'rb'), supports_streaming=True, caption='Te lo dice el negrito de ojos claros')
...
def nojoda(update, context):
    ...
    if reply_user == None:
        if len(context.args) != 0:
            word = ' '
            context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Nojoda.mp4', 'rb'), supports_streaming=True, caption='Que viva, ' + word.join(context.args) + ', nojoda!')
        else:
            context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Nojoda.mp4', 'rb'), supports_streaming=True)
    else:
        if reply_user.from_user['username'] == None:            
            context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Nojoda.mp4', 'rb'), supports_streaming=True, caption='Que viva, ' + reply_user.from_user['first_name'] + ', nojoda!')
        else:
            context.bot.send_video(chat_id=update.effective_chat.id, video=open('./media/Nojoda.mp4', 'rb'), supports_streaming=True, caption='Que viva, @'+ reply_user.from_user['username'] + '(' + reply_user.from_user['first_name'] + '), nojoda!')
...
def main():
    ...
    dp.add_handler(CommandHandler('this', this))
    dp.add_handler(CommandHandler('cringe', cringe))
    dp.add_handler(CommandHandler('mister', mister))
    dp.add_handler(CommandHandler('seso', seso))
